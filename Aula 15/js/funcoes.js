...
function fecharModal(){
  document.getElementById('modal_pai').style.backgroundColor="rgba(0,0,0,0.0)";
  document.getElementById('modal').style.marginTop="-600px";
}
...
function calcular(){
  ...
  document.getElementById('resultado').innerHTML = "O resuldato do cálculo é: " + resposta;
...
function validar(){
  if(document.getElementById('valor1').value == '' && document.getElementById('valor2').value ==''){
    ...
    document.getElementById('resultado').innerHTML = "Preencha os valores, pois são obrigatórios";
